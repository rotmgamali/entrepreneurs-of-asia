...
export default function Home() {
  return (
    <main className="flex-1 flex flex-col items-center">
      ...
      {/* ── Hero ── */}
      <section className="w-full max-w-5xl px-5 sm:px-8 pt-28 pb-20 md:pt-36 md:pb-28 flex flex-col items-center text-center">
      ...
      {/* ── Event Details ── */}
      <section className="w-full max-w-5xl px-5 sm:px-8 pb-20">
      ...
      {/* ── What Happens ── */}
      <section className="w-full max-w-5xl px-5 sm:px-8 pb-20">
        <h2 className="text-2xl font-bold text-white mb-8 text-center">What Happens</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="text-center p-6">
            ...
            <p className="text-sm text-gray-400">Two 20-minute presentations from founders building real businesses in Chiang Mai. Actionable advice, not fluff.</p>
          </div>
          <div className="text-center p-6">
            ...
            <p className="text-sm text-gray-400">After talks, we split into small groups by industry. Meet the right people, not just anyone.</p>
          </div>
          <div className="text-center p-6">
            <div className="text-3xl font-bold text-primary mb-3">03</div>
            <h3 className="text-white font-semibold mb-2">Community Access</h3>
            <p className="text-sm text-gray-400">Get added to our private WhatsApp and Facebook groups. Stay connected between events.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <span
                key={topic}
                className="px-4 py-2 rounded-full border border-border text-sm text-gray-300 hover:border-primary/50 hover:text-white transition-colors"
              >
                {topic}
              </span>
            ))}
      ...
      {/* ── RSVP / Sign Up ── */}
      <section className="w-full py-20" id="rsvp">
        <div className="max-w-5xl mx-auto px-5 sm:px-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-3 pt-4">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-[#25D366]/10 border border-[#25D366]/20 text-[#25D366] hover:bg-[#25D366]/20 px-4 py-2.5 rounded-lg transition-colors text-sm font-medium"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#1877F2]/10 border border-[#1877F2]/20 text-[#1877F2] hover:bg-[#1877F2]/20 px-4 py-2.5 rounded-lg transition-colors text-sm font-medium"
                >
      ...
      <footer className="w-full border-t border-border py-10">
        <div className="max-w-5xl mx-auto px-5 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <a
              href="https://instagram.com/entrepreneursofasia"
              target="_blank"
              rel="noopener noreferrer"
